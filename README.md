...
PAGES:1ST PAGE IS THE MAIN PAGE WHICH CONTAINS LINKS TO OTHER PAGES 
      :2ND PAGE IS THE EMPLOYEE PAGE WHICH CAN BE ACCESSED THROUGH MAIN PAGE:EMPLOYEE BUTTON HERE WE CAN ENTER NEW EMPLOYEE DETAILS DELETE PREVIOUS EMPLOYEEE DETAILS AND EDIT EMPLOYEE DETAILS
      :3RD PAGE IS CATEGORY PAGE WHICH CAN ALSO BE ACCESSED THROUGH MAIN PAGE VIA CATEGORY BUTTON HERE WE CAN ADD NEW PRODUCT CATEGORY,DELETE PREVIOUS CATEGORY,AND EDIT PRODUCT CATEGORY
      :4TH PAGE IS PRODUCT PAGE WHICH CAN ALSO BE ACCESSED THROUGH MAIN PAGE VIA PRODUCT BUTTON HERE WE CAN SEARCH,ADD,DELETE,EDIT PRODUCT IN AND FROM OUR DATABASE  
